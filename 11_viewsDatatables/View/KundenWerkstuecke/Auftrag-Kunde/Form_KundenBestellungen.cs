...
// aktuelle Zeile
int aktuelleZeile = 0;
try {  //Leere Tabellen sollten nicht zu einem Fehler führen
...
private void dataGridView_AT_CellEnter(object sender, DataGridViewCellEventArgs e) {
	Form_KundenBestellungen_Shown(sender, e);
}
	/// <summary>
...
#region 2.3 Navigatormenü und Mainmenü
/// <summary>
...
/// <summary>
/// Aufruf des Kindformulars (Unterformular)
/// und Aktivierung
/// </summary>
/// <param name="sender"></param>
/// <param name="e"></param>
private void viewLieferdienstToolStripMenuItem_Click(object sender, EventArgs e)
{
// Zeige das Kindformular
view.Show();
		// Aktivierung
		view.Activate();
...
{
// Tabellen aktualisieren (für alle Fälle)
...
CsharpMySql.con.Close();
		// Formulare schließen und Anwendung beenden
		ActiveForm.Close();

}
#endregion 2.3 Navigatormenü und Mainmenü
...
private void toolStripMenuItem_Loeschen_Click(object sender, EventArgs e)
{
	pictureBox_Werkstueck.Image = null;
		...
		private void menuStrip_Auftragsverwaltung_ItemClicked(object sender, ToolStripItemClickedEventArgs e)
		{
