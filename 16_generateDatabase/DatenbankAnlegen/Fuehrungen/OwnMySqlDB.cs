...
public BindingSource bindingSource;
		...
		/// <summary>
		/// 		/// Konstruktor der Datenbanken
		/// </summary>
		/// <param name="conStr"></param> Verbindungsstring
		/// <param name="count"></param> Nur für sich unterscheidende Parameterliste
		public CsharpMySql(string conStr, int count=1){
			CsharpMySql.connectionString = conStr;
