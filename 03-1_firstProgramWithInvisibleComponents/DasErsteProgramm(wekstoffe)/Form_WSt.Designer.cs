namespace DasErsteProgramm_wekstoffe_
{
  partial class Form_WSt
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.bindingSource_Wst = new System.Windows.Forms.BindingSource(this.components);
      this.werkstoffdatenDataSet1 = new DasErsteProgramm_wekstoffe_.werkstoffdatenDataSet1();
      this.label_infoWSt = new System.Windows.Forms.Label();
      this.werkstoffeTableAdapter = new DasErsteProgramm_wekstoffe_.werkstoffdatenDataSet1TableAdapters.werkstoffeTableAdapter();
      ...
      ((System.ComponentModel.ISupportInitialize)(this.bindingSource_Wst)).BeginInit();
      ((System.ComponentModel.ISupportInitialize)(this.werkstoffdatenDataSet1)).BeginInit();
      this.SuspendLayout();
      // 
      // menuStrip_WSt
      // 
      ...
      // dataGridView_WSt
      // 
      this.dataGridView_WSt.AutoGenerateColumns = false;
      ...
      this.dataGridView_WSt.DataSource = this.bindingSource_Wst;
      ...
      // bindingSource_Wst
      // 
      this.bindingSource_Wst.DataMember = "werkstoffe";
      this.bindingSource_Wst.DataSource = this.werkstoffdatenDataSet1;
      // 
      // werkstoffdatenDataSet1
      // 
      this.werkstoffdatenDataSet1.DataSetName = "werkstoffdatenDataSet1";
      this.werkstoffdatenDataSet1.SchemaSerializationMode = System.Data.SchemaSerializationMode.IncludeSchema;
      // 
      // label_infoWSt
      // 
      ...
      // 
      // werkstoffeTableAdapter
      // 
      this.werkstoffeTableAdapter.ClearBeforeFill = true;
      // 
      // Form_WSt
      // 
      ...
      this.Name = "Form_WSt";
      this.Text = "Werkstoffe - Komponentenbasiert Variante";
      ...
      ((System.ComponentModel.ISupportInitialize)(this.bindingSource_Wst)).EndInit();
      ((System.ComponentModel.ISupportInitialize)(this.werkstoffdatenDataSet1)).EndInit();
    ...
    private System.Windows.Forms.BindingSource bindingSource_Wst;
    private werkstoffdatenDataSet1 werkstoffdatenDataSet1;
    private werkstoffdatenDataSet1TableAdapters.werkstoffeTableAdapter werkstoffeTableAdapter;
  }
}
